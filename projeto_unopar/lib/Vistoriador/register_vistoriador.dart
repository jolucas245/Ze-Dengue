...
class VistoriadorRegister extends StatefulWidget {
  @override
  _VistoriadorRegisterState createState() => _VistoriadorRegisterState();
}

class _VistoriadorRegisterState extends State<VistoriadorRegister> {
  // Cores
  ...
  _cadastrarUsuario(Usuario usuario) {
    ...
    auth
      ...
      db
          .collection("usuario-vistoriador")
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => PrincipalVistoriador()));
    }).catchError((error) {
                      ...
                      child: Container(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              FadeAnimation(2.5,Text("Vistoriador"),),
                              FadeAnimation(2.5,Radio(
                                value: "Gestor",
                                groupValue: _escolhaUser,
                                onChanged: (String escolha){
                        ...
                        Padding(
                          ...
                          child: FadeAnimation(2.5, NiceButton(
                            gradientColors: [corQuaternaria, corTerciaria],
                            onPressed: (){
...
_fieldFocus(context, FocusNode atualFocus, FocusNode proximoFocus){
  atualFocus.unfocus();
